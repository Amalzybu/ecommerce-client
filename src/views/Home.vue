  ...
  <div class="carousel slide shadow mt-5" data-ride="carousel" id="carousel-1">
    <div class="carousel-inner">
      <div class="carousel-item active">
        <img
          class="w-100 d-block"
          src="@/assets/img/sliders/slider2.jpg"
          alt="Slide Image"
        />
      </div>
      <div class="carousel-item">
        <img
          class="w-100 d-block"
          src="@/assets/img/sliders/alvin-mahmudov-oBT4lJvNMQg-unsplash.jpg"
          alt="Slide Image"
        />
      </div>
      <div class="carousel-item">
        <img
          class="w-100 d-block"
          src="@/assets/img/sliders/slider10.jpg"
          alt="Slide Image"
        />
      </div>
      <div class="carousel-item">
        <img
          class="w-100 d-block"
          src="@/assets/img/sliders/slider3.jpg"
          alt="Slide Image"
        />
      </div>
    </div>
...
export default {
  ...
  async mounted() {
    ...
    await axios.get(url + "api/public/products").then((response) => {
