                        ...
                        <div class="card shadow"><img class="card-img-top w-100 d-block" :src="'http://amallama.alwaysdata.net/assets/img/products/Random/'+product.image+''" v-bind:alt="pic">
                            <div class="card-body">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6" v-if="itemInCart" ><button class="btn btn-primary btn-block" type="button" @click="addToCart()"><i class="la la-shopping-cart" style="font-size: 24px;"></i></button></div>
                                    <div class="col-md-6"  v-else><button class="btn btn-outline-dark btn-block" type="button" @click="addToCart()" ><i class="icon-handbag" style="font-size: 18px;"></i></button></div>
                                </div>
                            </div>
                        </div>
                    </div>
